...
export const searchIndex: SearchResult[] = [
  ...
  {
    id: "research-geophysical-exploration",
    title: "Geophysical Exploration",
    description: "Applied geophysics for gold and groundwater exploration in Ghana",
    category: "Research",
    url: "/",
    keywords: ["gold exploration", "groundwater", "geophysical methods", "Ghana", "mineral prospecting"],
    content: "Led geophysical investigations for gold mineralization in the Kibi-Winneba belt and groundwater resources in the Densu River Basin and Volta Region. Pioneered use of time-domain induced polarization for solid waste characterization in developing countries.",
  },
