...
const timelineData = [
  ...
  { year: "1999", title: "Associate Professor", text: "Elevated to Associate Professor in October 1999, establishing himself as a leading researcher across four areas: rock and mineral magnetism, geophysical exploration for minerals, groundwater exploration, and environmental geophysics." },
